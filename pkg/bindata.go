...
func schemaSchemaJson() (*asset, error) {
	...
	info := bindataFileInfo{name: "schema/schema.json", size: 1338, mode: os.FileMode(420), modTime: time.Unix(1529464900, 0)}
...
func schemaSchemaYaml() (*asset, error) {
	...
	info := bindataFileInfo{name: "schema/schema.yaml", size: 865, mode: os.FileMode(420), modTime: time.Unix(1529464785, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
