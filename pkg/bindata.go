...
func schemaSchemaJson() (*asset, error) {
	...
	info := bindataFileInfo{name: "schema/schema.json", size: 1992, mode: os.FileMode(420), modTime: time.Unix(1530842301, 0)}
...
func schemaSchemaYaml() (*asset, error) {
	...
	info := bindataFileInfo{name: "schema/schema.yaml", size: 1294, mode: os.FileMode(420), modTime: time.Unix(1529521862, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
